...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 02:33 AM
...
--
ALTER TABLE `checked`
  ADD CONSTRAINT `Test` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`);

--
-- Constraints for table `rooms`
--
ALTER TABLE `rooms`
  ADD CONSTRAINT `Test2` FOREIGN KEY (`category_id`) REFERENCES `room_categories` (`id`);
COMMIT;
